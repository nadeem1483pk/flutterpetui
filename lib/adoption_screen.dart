...
import 'package:petpal_ui/animal_screen_detail.dart';
        ...
        child: Column(
          children: <Widget>[
            InkWell(
              ...
              child: Material(
                color: selectedAnimalIconIndex == 0
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: ListView.builder(
                            ...
                            itemCount: animalTypes.length + 1,
                            itemBuilder: (context, index) {
                              if (index == 0) {
                                return buildAllIcon();
                              }
                              return buildAnimalIcon(animalTypes[index - 1]);
                            }),
                      ),
                      Expanded(
                        child: ListView.builder(
                                            ...
                                            Flexible(
                                              child: Column(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Text(
                                                    '${product.scientific_name}(${product.gender})',
                                                    style: TextStyle(
                                                      fontSize: 16.0,
                                                  ...
                                                  Row(
                                                    children: <Widget>[
                                                      ...
                                                      Text(
                                                        'Distance: ${product.distance_to_user}',
                                                        style: TextStyle(
                                                          fontSize: 16.0,
                                                          color:
                                                              Theme.of(context)
                                      ...
                                      children: <Widget>[
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            ...
                                            // You can also navigate to another screen or perform any action you need
                                          },
                                          child: MouseRegion(
